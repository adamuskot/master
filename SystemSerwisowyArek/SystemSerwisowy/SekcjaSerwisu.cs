...
namespace SystemSerwisowy
{
    public partial class SekcjaSerwisu : Form
    {
        ...
        public void AktualizujGrida()
        {
            ...
            {
                if (row.Cells[10].Value.ToString() == "Naprawiony")
                {
                    row.DefaultCellStyle.BackColor = Color.LightGreen;
                }
                else if (row.Cells[10].Value.ToString() == "Brak możliwości naprawy")
                {
                    row.DefaultCellStyle.BackColor = Color.Red;
                }
                else if (row.Cells[10].Value.ToString() == "Wysłane na gwarancję")
                {
                    row.DefaultCellStyle.BackColor = Color.Yellow;
                }
                else if (row.Cells[10].Value.ToString() == "Przyjęty do naprawy")
                {
        ...
        private void generujWydruk(System.Drawing.Printing.PrintPageEventArgs e, int ind)
        {
            ...
            for (int indeks = 0; indeks < 2; indeks++)
            {
                ...
                e.Graphics.DrawRectangle(new Pen(Brushes.Black, 1), new Rectangle(70, 255 + indeks * 550, 340, 97));
                e.Graphics.DrawRectangle(new Pen(Brushes.Black, 1), new Rectangle(410, 255 + indeks * 550, 340, 97));
